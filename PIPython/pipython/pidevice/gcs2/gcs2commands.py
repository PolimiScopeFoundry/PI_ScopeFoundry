...
import PI_ScopeFoundry.PIPython.pipython
...
__signature__ = 0xb75696142d765e4e3bb926556b953b76
...
class GCS2Commands(GCSBaseCommands):
    ...
    def isgcs2(self):
        ...
        return self.devname not in gcsbasecommands.GCS1DEVICES
    ...
    def logfile(self):
        ...
        return super(GCS2Commands, self).logfile

    @logfile.setter
    def logfile(self, filepath):
        """Full path to file where to save communication to/from device."""
        super(GCS2Commands, self.__class__).logfile.fset(self, filepath)

    @property
    def timeout(self):
        """Get current timeout setting in milliseconds."""
        return super(GCS2Commands, self).timeout
    ...
    def timeout(self, value):
        ...
        """
        super(GCS2Commands, self.__class__).timeout.fset(self, value)
    ...
    def bufstate(self):
        ...
        """
        return super(GCS2Commands, self).bufstate
    ...
    def bufdata(self):
        ...
        """
        return super(GCS2Commands, self).bufdata
